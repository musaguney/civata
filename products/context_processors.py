...
def index_product(request):
    ...
    # index_product değişkenini kullanarak ürünleri kategorilere göre grupla
    index_product = []
    for category in categories:
        products = category.products.all()  # Her kategoriden yalnızca 2 ürün al
        if products:  # Eğer ürün varsa işleme devam et
            index_product.append({
                ...
                'products': [
                    {
                        ...
                        'diameters': product.diameters or 'Belirtilmemiş',
                        'lengths': product.lengths or 'Belirtilmemiş',
